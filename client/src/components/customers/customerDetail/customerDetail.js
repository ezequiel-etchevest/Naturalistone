...
// import { cleanCustomerRelationship, getCustomerRelationship } from "../../../redux/actions-customers";

const CustomerDetail = ({user, customer, projects_by_customer_id, customer_relationship }) => {
