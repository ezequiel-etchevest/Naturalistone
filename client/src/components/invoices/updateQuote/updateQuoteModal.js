...
import { createQuote, updateQuote } from "../../../redux/actions-invoices";
          ...
          <ModalContent 
 ...
 
            {
              component === 'Customer' && progress == 60 &&(
                <CreateQuoteCustomerProjets formData={formData} setFormData={setFormData} setDisable={setDisable} update={update}  invoice={invoice}/>
                        ...
                        {
              component === 'Project' && progress == 100 &&(
                <CreateQuoteCustomerProjets formData={formData} setFormData={setFormData} setDisable={setDisable} update={update}  invoice={invoice}/>
              )
            }

            {
              component === 'Products' && progress == 20 &&(
                <CreateQuoteProducts formData={formData} setFormData={setFormData} setDisable={setDisable}/>
              )
            }
                                                {/*
            {
              !submited && progress == 100 &&  (
                Object.entries(formData.products).length ?
                  <CreateQuoteProductsReview formData={formData} setFormData={setFormData}/>
                :
            ...
            {
              submited && progress == 100 && (
                  <CreatedQuotePdf formData={formData} setFormData={setFormData} authFlag={authFlag} user={user}/>
              )
            }*/}
            </ModalBody> 
            {
              !submited && (
                <ModalFooter mb={'2vh'} mt={'2vh'} display={'flex'} flexDir={'row'} justifyContent={'space-between'} ml={'1vw'} mr={'0.5vw'}>
                  ...
                  {
                  component === 'Customer' && progress === 60 || component === 'Project' && progress === 100 
                  ? (
