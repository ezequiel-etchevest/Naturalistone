            ...
            <Box
              ...
              <TableContainer>
                  <Table color={'web.text'}variant={'simple'} size={'sm'}>
                      <Thead h={'6vh'}>
                          <Tr h={'6vh'}>
                            <Th color={'web.text2'} textAlign={'center'} fontSize={'x-small'}>Product Name</Th>
                            <Th color={'web.text2'} textAlign={'center'} fontSize={'x-small'}>Type</Th>
                            <Th color={'web.text2'} textAlign={'center'} fontSize={'x-small'}>Finish</Th>
                          </Tr>
                      </Thead>
                      <Tbody>
                          { 
