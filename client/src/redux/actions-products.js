  ...
  return async function (dispatch) {
    try {
      let { data } = await axios.get(
        `/products/new_quote?finish=${finish}&material=${material}&search=${search}`
      );
      dispatch({
...
export function getAllProductsNewSamples(finish, material, search) {
  return async function (dispatch) {
    try {
      let { data } = await axios.get(
        `/products/new_samples?finish=${finish}&material=${material}&search=${search}`
      );
      dispatch({
...
export function getMaterials() {
  return async function (dispatch) {
    try {
      let { data } = await axios.get(`/products/materials`);
      dispatch({
        type: GET_MATERIALS,
        payload: data.data,
      });
